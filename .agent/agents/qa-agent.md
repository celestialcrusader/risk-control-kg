...
# Review Guidelines
1. Read the target story ticket in [mvp-sprint.md](file:///home/zackchow/coding/rckg/docs/03-mvp/mvp-sprint.md) and the developer's work log in `docs/03-mvp/work-log-<STORY-ID>.md`.
