...
2. **Deterministic File Naming Conventions:**
   - Work Logs: `docs/03-mvp/work-log-<STORY-ID>.md` (e.g. `docs/03-mvp/work-log-RCKG-100.md`)
   - QA Reports: `docs/03-mvp/qa-report-<STORY-ID>.md` (e.g. `docs/03-mvp/qa-report-RCKG-100.md`)
