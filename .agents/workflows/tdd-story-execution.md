---
description: This specification establishes the official **SWE ↔ QA Execution Loop Workflow** for delivering story tickets from the Master Sprint Plan ([mvp-sprint.md](docs/03-mvp/mvp-sprint.md)).
---
